...
class RegisterListSerializer(serializers.ModelSerializer):
    class Meta:
        model = Account
        fields = ['id', 'email', 'first_name', 'last_name', 'image', 'role', 'is_superuser', 'is_active', 'is_staff', 'bio']
...
class MyAccountSerializer(serializers.ModelSerializer):
    class Meta:
        model = Account
        fields = ('id', 'email', 'first_name', 'role', 'get_role_display', 'last_name', 'image_url', 'bio', 'date_created', 'date_modified')
